...
export const reminderFormulas: ReminderFormula[] = [
  {
    id: "comercial",
    title: "ROTINA COMERCIAL: ORCAMENTOS E AGENDA",
    description: "REGRAS DO DIA A DIA PARA MANTER CRM, AGENDA E HISTORICO COMERCIAL COERENTES.",
    items: [
      "AO ALTERAR UM ORCAMENTO ABERTO, A OPORTUNIDADE VINCULADA RECEBE OS DADOS NOVOS. A AGENDA EXISTENTE E MANTIDA, SEM DUPLICAR.",
      "ATUALIZAR O ORCAMENTO NAO FECHA A VENDA E NAO REGISTRA PEDIDO. USE GANHO OU REGISTRAR PEDIDO QUANDO A COMPRA FOR CONFIRMADA.",
      "ORCAMENTO DIRETO GERA OPORTUNIDADE E AGENDA PARA O PROXIMO DIA UTIL. ELE APARECE COMO ORCAMENTO DIRETO ATE TER CLIENTE VINCULADO.",
      "QUANDO TIVER OS DADOS DO CLIENTE, VINCULE O ORCAMENTO DIRETO AO CLIENTE CADASTRADO. A OPORTUNIDADE E A AGENDA PASSAM PARA O FLUXO NORMAL.",
      "NAO CRIE CLIENTE FICTICIO PARA ORCAMENTO DIRETO. ISSO PREJUDICA A CARTEIRA, OS RELATORIOS E O CICLO DE COMPRA.",
      "CRIE OUTRA OPORTUNIDADE PARA UM NEGOCIO INDEPENDENTE. PARA O MESMO NEGOCIO, ATUALIZE A OPORTUNIDADE E O ORCAMENTO QUE JA EXISTEM.",
      "SE O ORCAMENTO JA FOI APROVADO, MARQUE SUA OPORTUNIDADE COMO GANHA. PARA UMA NOVA NEGOCIACAO, CRIE OUTRO ORCAMENTO: ELE GERA OUTRA OPORTUNIDADE NO CRM, COM ITENS, VALORES E RESULTADO SEPARADOS, PRESERVANDO O HISTORICO ANTERIOR.",
      "SE O CLIENTE COMPRAR UM ITEM HABITUAL ENQUANTO NEGOCIA OUTRO ITEM, REGISTRAR PEDIDO CRIA UMA VENDA SEPARADA E RECALCULA O CICLO CONFORME A FREQUENCIA CADASTRADA. A OPORTUNIDADE DO OUTRO ORCAMENTO E SUA AGENDA CONTINUAM ABERTAS.",
      "REGISTRE O PEDIDO COM OS ITENS E QUANTIDADES PARA PRESERVAR A VENDA, A MARGEM E O HISTORICO DE COMPRA.",
      "NAS AMOSTRAS, USE A DATA PREVISTA COMO CONTROLE E REGISTRE A BAIXA QUANDO CONCLUIR PARA MEDIR O PRAZO REAL.",
    ],
  },
  {
    id: "variaveis",
