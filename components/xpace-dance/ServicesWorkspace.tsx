...
type Service = { id: string; description: string; salePriceCents: number; ncm: string; cest: string; imageUrl: string; active: boolean };
type Draft = { description: string; price: string; ncm: string; cest: string; imageUrl: string };
const emptyDraft = (): Draft => ({ description: "", price: "", ncm: "", cest: "", imageUrl: "" });
...
export default function ServicesWorkspace() {
  ...
  function startEdit(service: Service) { setEditingId(service.id); setDraft({ description: service.description, price: centsToInput(service.salePriceCents), ncm: service.ncm, cest: service.cest, imageUrl: service.imageUrl }); setImageFile(null); setNotice(""); setView("FORM"); }
  ...
  async function save(event: FormEvent) {
    ...
    try {
      const body = { description: draft.description, salePriceCents: inputToCents(draft.price), ncm: draft.ncm, cest: draft.cest };
