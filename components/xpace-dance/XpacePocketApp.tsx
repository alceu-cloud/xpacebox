...
function Home({ userId }: { userId: string }) {
  ...
  function switchTab(next: Tab) {
    setTab(next); setSelectedClass(null); setShowNotifications(false); setShowWeekTrials(false);
  }
...
function WeekTrials({ agenda, onBack }: { agenda: AgendaResponse | null; onBack: () => void }) {
