...
function Field({ label, value, onChange, type = "text", lower = false, options, placeholder, readOnly = false }: { label: string; value: string; onChange: (value: string) => void; type?: string; lower?: boolean; options?: Array<{ value: string; label: string }>; placeholder?: string; readOnly?: boolean }) {
